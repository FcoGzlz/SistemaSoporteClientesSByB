                                                     ...
                                                     <div class="form-row">
                                                         <div class="col-lg-12 col-xl-12">
                                                             <div class="form-group">
                                                                 <div class="form-row">
                                                                     <div class="col-xl-12"><label class="col-form-label">{{Carbon\Carbon::parse($detalle->fecha)->isoFormat('dddd, D MMMM, YYYY, HH:mm')}}<button class="btn btn-primary" id="btnEditarRetroTO" type="button">Editar</button><button class="btn btn-primary" id="btnGuardarRetroTO" type="submit">Guardar</button></label></div>
                                                                 </div><textarea class="form-control @error('detalleEdit') is-invalid
